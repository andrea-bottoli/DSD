...
public class PylonForcesFormulas {
	 ...
	 */
	protected static float ForceNcontributionPP(float stackWeight) {
	 ...
	 */
	protected static float ForceNcontributionN(float n) {
		float contributionN;
		contributionN = n / 3;
	 ...
	 */
	protected static float ForceNcontributionTy(float ty, float d, float h1, float l2) {
	 ...
	 */
	protected static float ForceNcontributionMx(float mx) {
	 ...
	 */
	protected static float ForceNcontributionQy(float H1, float d, float h1, float l2) {
	 ...
	 */
	protected static float ForceTxContributionTx(float tx){
	 ...
	 */
	protected static float ForceTyContributionTy(float ty){
		float contributionTy;
	 ...
	 */
	protected static float ForceTyContributionQy(float H){
		float contributionQy;
	 ...
	 * @return The contribution at the Ty force on each pylon
	 */
	protected static float ForceMxContributionTy(float ty, float l2){
		float contributionTy;
	...
	protected static float ForceMxContributionQy(float H1, float l2){
		float contributionQy;
	 ...
	 * @return The contribution at the Tx force on each pylon
	 */
	protected static float ForceMyContributionTx(float tx, float l){
		float contributionTx;
