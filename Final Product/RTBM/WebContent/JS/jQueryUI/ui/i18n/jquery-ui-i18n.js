...
jQuery(function($){
	$.datepicker.regional['ar-DZ'] = {
		...
		nextText: 'التالي&#x3E;',
		currentText: 'اليوم',
		monthNames: ['جان�?ي', '�?ي�?ري', 'مارس', 'أ�?ريل', 'ماي', 'جوان',
		'جويلية', 'أوت', 'سبتمبر','أكتوبر', 'نو�?مبر', 'ديسمبر'],
...
jQuery(function($){
	$.datepicker.regional['hi'] = {
		...
		nextText: 'अगला',
		currentText: 'आज',
		monthNames: ['जनवरी ','फरवरी','मार�?च','अप�?रेल','मई','जून',
		'जूलाई','अगस�?त ','सितम�?बर','अक�?टूबर','नवम�?बर','दिसम�?बर'],
		monthNamesShort: ['जन', 'फर', 'मार�?च', 'अप�?रेल', 'मई', 'जून',
		'जूलाई', 'अग', 'सित', 'अक�?ट', 'नव', 'दि'],
...
jQuery(function($){
	$.datepicker.regional['vi'] = {
		...
		'Tháng Bảy', 'Tháng Tám', 'Tháng Chín', 'Tháng Mư�?i', 'Tháng Mư�?i Một', 'Tháng Mư�?i Hai'],
